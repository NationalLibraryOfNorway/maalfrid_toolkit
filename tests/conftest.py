...
def xhtml_unicode_string_with_wrong_encoding_declaration_text_content():
    return "Eksempel-XHTML fra NasjonalbiblioteketHello, world! — med ISO‑8859‑1-kodering."
